...
import { getWarriorRankInfo, getPetEmoji } from '../types';
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center justify-center gap-2 mb-3">
                    <span className="text-xl">{warriorInfo.emoji}</span>
                    <span className="text-sm font-medium text-amber-400">{warriorInfo.name}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-center gap-4 mb-3">
                    <div className="flex items-center gap-1">
                      ...
                      {kid.currentPet && (
                        <span className="text-xs text-slate-400">{kid.currentPet.name}</span>
                      )}
                    </div>
                  </div>
